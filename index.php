    ...
    <div class="imgSliderSlider" onmouseleave="slideChange()"
        ...
        <div class="imgSliderSlide">
            ...
            <div class="imgSliderTextContainer">
                <p class="imgSliderHeader">Railings</p>
        ...
        <div class="imgSliderSlide">
            <img src="images/IMG_0963.JPG" />
            <div class="imgSliderTextContainer2">
                <p class="imgSliderHeader2">Stairs</p>
        ...
        <div class="imgSliderSlide">
            ...
            <div class="imgSliderTextContainer2">
                <p class="imgSliderHeader2">View Our Work</p>
        ...
        <a class="imgSliderPrev" onclick="prevSlide()">&#10096</a>
        <a class="imgSliderNext" onclick="nextSlide()">&#10097</a>
...
<section class="welcome-wrapper">
    <div class="welcome-container">
        <h1>Specializing in stairs, handrails, and balusters since 1998</h1>
        <hr width="20%">
...
<section class="services-wrapper">
    <div class="services-container">
        ...
        <div class="service-items">
            <div class="info">
                <a href="stairs.php"><img src="images/IMG_1442.png"></a>
                <h4>STAIRCASES</h4>
            ...
            <div class="info">
                <a href="rails.php"><img src="images/4714.png"></a>
                <h4>RAILINGS</h4>
...
<section class="services-wrapper">
    <div class="services-container" style="background-color: #ffffff;">
        ...
        <div class="service-items priorities">
            ...
            <div class="info">
                <img src="images/icon-pictures.png">
                <h4>REAL RESULTS</h4>
...
<section>
    <div class="map-container">
        ...
        <div>
            <p class="map-heading">Serving the greater Frederick, central
                Maryland area</p>
